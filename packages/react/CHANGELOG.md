...
- f249750: Major visual redesign of the interview UI — a genuine design pass, not incremental polish. No public prop APIs changed; every existing integration keeps working exactly as before.
